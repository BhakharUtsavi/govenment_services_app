...
class BookTrainTicket_GoToSite extends StatefulWidget {
  const BookTrainTicket_GoToSite({super.key});

  @override
  State<BookTrainTicket_GoToSite> createState() => _BookTrainTicket_GoToSiteState();
}

class _BookTrainTicket_GoToSiteState extends State<BookTrainTicket_GoToSite> {

...
class CheckAadharStatus_GoToSite extends StatefulWidget {
  const CheckAadharStatus_GoToSite({super.key});

  @override
  State<CheckAadharStatus_GoToSite> createState() => _CheckAadharStatus_GoToSiteState();
}

class _CheckAadharStatus_GoToSiteState extends State<CheckAadharStatus_GoToSite> {

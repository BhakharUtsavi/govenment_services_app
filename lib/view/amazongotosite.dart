...
class Amazon_GoToSite extends StatefulWidget {
  const Amazon_GoToSite({super.key});

  @override
  State<Amazon_GoToSite> createState() => _Amazon_GoToSiteState();
}

class _Amazon_GoToSiteState extends State<Amazon_GoToSite> {

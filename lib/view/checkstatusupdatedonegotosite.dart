...
class CheckStatusUpdateDone_GoToSite extends StatefulWidget {
  const CheckStatusUpdateDone_GoToSite({super.key});

  @override
  State<CheckStatusUpdateDone_GoToSite> createState() => _CheckStatusUpdateDone_GoToSiteState();
}

class _CheckStatusUpdateDone_GoToSiteState extends State<CheckStatusUpdateDone_GoToSite> {

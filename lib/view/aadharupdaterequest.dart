...
class AadharUpdateRequest extends StatefulWidget {
  const AadharUpdateRequest({super.key});

  @override
  State<AadharUpdateRequest> createState() => _AadharUpdateRequestState();
}

class _AadharUpdateRequestState extends State<AadharUpdateRequest> {
  void goToSite() {
    showDialog(
        context: context,
                  ...
                  children: [
                    ...
                    ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.of(context).pushNamed("aadharupdaterequestgotosite",arguments: url);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Aadhar Update Request",

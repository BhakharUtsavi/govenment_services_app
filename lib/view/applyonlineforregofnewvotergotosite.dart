...
class ApplyOnlineForRegOfNewVoter_GoToSite extends StatefulWidget {
  const ApplyOnlineForRegOfNewVoter_GoToSite({super.key});

  @override
  State<ApplyOnlineForRegOfNewVoter_GoToSite> createState() => _ApplyOnlineForRegOfNewVoter_GoToSiteState();
}

class _ApplyOnlineForRegOfNewVoter_GoToSiteState extends State<ApplyOnlineForRegOfNewVoter_GoToSite> {

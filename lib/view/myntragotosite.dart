...
class Myntra_GoToSite extends StatefulWidget {
  const Myntra_GoToSite({super.key});

  @override
  State<Myntra_GoToSite> createState() => _Myntra_GoToSiteState();
}

class _Myntra_GoToSiteState extends State<Myntra_GoToSite> {

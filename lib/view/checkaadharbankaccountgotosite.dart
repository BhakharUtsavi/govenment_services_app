...
class CheckAadharBankAccount_GoToSite extends StatefulWidget {
  const CheckAadharBankAccount_GoToSite({super.key});

  @override
  State<CheckAadharBankAccount_GoToSite> createState() => _CheckAadharBankAccount_GoToSiteState();
}

class _CheckAadharBankAccount_GoToSiteState extends State<CheckAadharBankAccount_GoToSite> {

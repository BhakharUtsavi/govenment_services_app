...
class McdonaldGoToSite extends StatefulWidget {
  const McdonaldGoToSite({super.key});

  @override
  State<McdonaldGoToSite> createState() => _McdonaldGoToSiteState();
}

class _McdonaldGoToSiteState extends State<McdonaldGoToSite> {

...
class AirIndia_GoToSite extends StatefulWidget {
  const AirIndia_GoToSite({super.key});

  @override
  State<AirIndia_GoToSite> createState() => _AirIndia_GoToSiteState();
}

class _AirIndia_GoToSiteState extends State<AirIndia_GoToSite> {

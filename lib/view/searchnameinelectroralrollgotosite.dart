...
class SearchNameInElectroralRoll_GoToSite extends StatefulWidget {
  const SearchNameInElectroralRoll_GoToSite({super.key});

  @override
  State<SearchNameInElectroralRoll_GoToSite> createState() => _SearchNameInElectroralRoll_GoToSiteState();
}

class _SearchNameInElectroralRoll_GoToSiteState extends State<SearchNameInElectroralRoll_GoToSite> {

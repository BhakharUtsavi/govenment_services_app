...
class DownloadAadhar_GoToSite extends StatefulWidget {
  const DownloadAadhar_GoToSite({super.key});

  @override
  State<DownloadAadhar_GoToSite> createState() => _DownloadAadhar_GoToSiteState();
}

class _DownloadAadhar_GoToSiteState extends State<DownloadAadhar_GoToSite> {

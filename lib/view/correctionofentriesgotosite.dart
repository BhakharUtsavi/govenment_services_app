...
class CorrectionOfEntries_GoToSite extends StatefulWidget {
  const CorrectionOfEntries_GoToSite({super.key});

  @override
  State<CorrectionOfEntries_GoToSite> createState() => _CorrectionOfEntries_GoToSiteState();
}

class _CorrectionOfEntries_GoToSiteState extends State<CorrectionOfEntries_GoToSite> {

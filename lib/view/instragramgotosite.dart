...
class InstragramGoToSite extends StatefulWidget {
  const InstragramGoToSite({super.key});

  @override
  State<InstragramGoToSite> createState() => _InstragramGoToSiteState();
}

class _InstragramGoToSiteState extends State<InstragramGoToSite> {

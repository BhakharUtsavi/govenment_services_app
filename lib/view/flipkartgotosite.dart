...
class Flipkart_GoToSite extends StatefulWidget {
  const Flipkart_GoToSite({super.key});

  @override
  State<Flipkart_GoToSite> createState() => _Flipkart_GoToSiteState();
}

class _Flipkart_GoToSiteState extends State<Flipkart_GoToSite> {

...
class SearchTrain_GoToSite extends StatefulWidget {
  const SearchTrain_GoToSite({super.key});

  @override
  State<SearchTrain_GoToSite> createState() => _SearchTrain_GoToSiteState();
}

class _SearchTrain_GoToSiteState extends State<SearchTrain_GoToSite> {

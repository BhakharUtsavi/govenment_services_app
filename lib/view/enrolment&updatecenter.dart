...
class EnrolmentUpdateCenter extends StatefulWidget {
  const EnrolmentUpdateCenter({super.key});

  @override
  State<EnrolmentUpdateCenter> createState() => _EnrolmentUpdateCenterState();
}

class _EnrolmentUpdateCenterState extends State<EnrolmentUpdateCenter> {
                ...
                Row(
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      Navigator.of(context).pushNamed("enrolmentupdatecentergotosite",arguments: url);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Enrolment & Update Centers",

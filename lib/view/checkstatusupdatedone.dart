...
class CheckStatusUpdateDone extends StatefulWidget {
  const CheckStatusUpdateDone({super.key});

  @override
  State<CheckStatusUpdateDone> createState() => _CheckStatusUpdateDoneState();
}

class _CheckStatusUpdateDoneState extends State<CheckStatusUpdateDone> {
  void goToSite() {
    showDialog(
        context: context,
                  ...
                  children: [
                    ...
                    ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.of(context).pushNamed("checkstatusupdatedonegotosite",arguments: url);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Check Status Update Done",

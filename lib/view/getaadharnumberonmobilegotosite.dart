...
class GetAadharNumberOnMobile_GoToSite extends StatefulWidget {
  const GetAadharNumberOnMobile_GoToSite({super.key});

  @override
  State<GetAadharNumberOnMobile_GoToSite> createState() => _GetAadharNumberOnMobile_GoToSiteState();
}

class _GetAadharNumberOnMobile_GoToSiteState extends State<GetAadharNumberOnMobile_GoToSite> {

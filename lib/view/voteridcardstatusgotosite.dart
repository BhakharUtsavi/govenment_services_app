...
class VoterIDCardStatus_GoToSite extends StatefulWidget {
  const VoterIDCardStatus_GoToSite({super.key});

  @override
  State<VoterIDCardStatus_GoToSite> createState() => _VoterIDCardStatus_GoToSiteState();
}

class _VoterIDCardStatus_GoToSiteState extends State<VoterIDCardStatus_GoToSite> {
